...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    .doc-ref { font-size: 12px; color: #d4b483; font-weight: 600; letter-spacing: .04em; margin-top: 3px; }
    .pill { border-radius: 999px; padding: 5px 12px; font-size: 8.5px; font-weight: bold;
            text-transform: uppercase; letter-spacing: .1em; }
    .pill-due { background: #c19a5b; color: #14110d; }
    .pill-paid { background: #7d9d8a; color: #12251a; }
    .pill-void { background: #57534e; color: #e7e5e4; }
    .accent-rule { height: 3px; background: #c19a5b; font-size: 0; line-height: 0; }
    ...
    .facts td.highlight { background: #faf7f0; border-color: #e0cfa8; }
    ...
    .facts .highlight .v { color: #8a6a30; font-size: 14px; font-weight: bold; }
    ...
    /* ---------------------------------------------------------------- payment */
    .payment { border: 1px solid #ebe7e1; border-left: 3px solid #c19a5b; border-radius: 8px; padding: 11px 14px; }

...
class ReviewGenerator
{
    ...
    private const POSITIVE_COMMENTS = [
        ...
        "Confortable dès la première sortie, je recommande vivement !",
        "Excellent rapport qualité-prix, je suis ravi.",
        "Le design est encore plus beau en vrai qu'en photo.",
        "Parfait pour un usage quotidien, très bonne tenue.",
        "Deuxième commande chez Maison Vélocité, toujours aussi bien.",
        "Service client réactif et produit de qualité, rien à redire.",
        "Correspond parfaitement au guide des tailles.",
        "Matériaux de bonne qualité, finitions soignées.",
        "Je suis client fidèle et je ne suis jamais déçu.",
        "Un achat que je referais sans hésiter.",
        "Très bon confort, idéal pour rouler toute la journée.",
        "Le produit a dépassé mes attentes, merci !",
        "Emballage soigné et livraison dans les délais annoncés.",
        "Montage facile et prise en main immédiate, j'adore.",
        "Facile à entretenir et très résistant dans le temps.",
    ...
    private const NEUTRAL_COMMENTS = [
        ...
        "Produit sympa mais le réglage a demandé un peu de patience.",
